 ...
 * the Comparable<T> interface so that a PriorityQueue can
 * arrange the events in the order of event time.  For Exercise
 * 1, you do not have to worry about what Comparable<T> and
 * PriorityQueue<T> do.
 *
 * @author Wei Tsang
